...
Generated: 2026-07-15T16:05:48.707Z
...
|--|--:|--|--|--|--|--|--|--|--|--|--:|--|
| desktop (1440×1200) | 200 | ✅ | ✅ | ✅ 8/8 | ✅ 7/7 | ✅ 0/0 | ✅ 0 | ✅ 0 | ✅ 1440/1440 | ✅ 0 | 4 | `.planning/screenshots/flytrap-public-desktop-ready.png` |
...
Diagnostics:
- console warning: [.WebGL-0x1040047d800]GL Driver Message (OpenGL, Performance, GL_CLOSE_PATH_NV, High): GPU stall due to ReadPixels
- console warning: THREE.Clock: This module has been deprecated. Please use THREE.Timer instead.
- console warning: [.WebGL-0x10400479600]GL Driver Message (OpenGL, Performance, GL_CLOSE_PATH_NV, High): GPU stall due to ReadPixels
- console warning: [.WebGL-0x10400479600]GL Driver Message (OpenGL, Performance, GL_CLOSE_PATH_NV, High): GPU stall due to ReadPixels (this message will no longer repeat)
