...
| 17 | `@flytrap/ui` distribuível por `dist` | consumo externo não deve depender de `.tsx` cru nem do pipeline interno do monorepo; apps locais mantêm aliases Vite para hot reload em `src` |
