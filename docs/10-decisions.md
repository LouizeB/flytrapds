...
| 19 | RAG remoto, embeddings e Edge Function adiados após a primeira release pública | a memória local source-backed já cobre 101 fontes com fallback offline; infraestrutura remota só entra quando um produto externo demonstrar ganho mensurável de recuperação que justifique custo, segurança e operação |
